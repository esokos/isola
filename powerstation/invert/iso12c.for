...
c      enddo
      ...
      read(151,*) 
      read(151,*) 
      read(151,*) f1,f2,f3,f4	! bot used (read from allstat)
      read(151,*)
      read(151,*) vardat
...
cc	read(*,*)   iselect
      ...
      call elemat2_12c_new(filename,w,rold,rinv)  ! analyzing system matrix for the best position (independent of time shift) 
