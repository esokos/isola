...
%      stop.  All inputs are passed to crustmod2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help crustmod2

% Last Modified by GUIDE v2.5 27-Jun-2009 15:09:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @crustmod2_OpeningFcn, ...
                   'gui_OutputFcn',  @crustmod2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before crustmod2 is made visible.
function crustmod2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to crustmod2 (see VARARGIN)

% Choose default command line output for crustmod2
handles.output = hObject;
h=dir('crustalmodel.isl');

if length(h) == 0; 
  disp('Crustalmodel.isl file doesn''t exist. Default crustal model will be loaded');
  
else
    fid = fopen('Crustalmodel.isl','r');
    crufile=fgetl(fid);
    fclose(fid);
disp(['Found Crustalmodel.isl model   ' crufile '   will be loaded'])
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fid  = fopen(crufile,'r');
...
% UIWAIT makes crustmod2 wait for user response (see UIRESUME)
% uiwait(handles.crustmod2);


% --- Outputs from this function are returned to the command line.
function varargout = crustmod2_OutputFcn(hObject, eventdata, handles)
...
disp('This is Crustmod2 28/09/2011');
