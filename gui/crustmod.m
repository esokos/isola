function varargout = crustmod(varargin)
% CRUSTMOD M-file for crustmod.fig
%      CRUSTMOD, by itself, creates a new CRUSTMOD or raises the existing
%      singleton*.
%
%      H = CRUSTMOD returns the handle to a new CRUSTMOD or the handle to
%      the existing singleton*.
%
%      CRUSTMOD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CRUSTMOD.M with the given input arguments.
%
%      CRUSTMOD('Property','Value',...) creates a new CRUSTMOD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before crustmod_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to crustmod_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help crustmod

% Last Modified by GUIDE v2.5 20-Sep-2005 13:39:43

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @crustmod_OpeningFcn, ...
                   'gui_OutputFcn',  @crustmod_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before crustmod is made visible.
function crustmod_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to crustmod (see VARARGIN)

% Choose default command line output for crustmod
handles.output = hObject;

disp('This is Crustmod 28/09/2011');
%
...
% UIWAIT makes crustmod wait for user response (see UIRESUME)
% uiwait(handles.crustmod);


% --- Outputs from this function are returned to the command line.
function varargout = crustmod_OutputFcn(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function desity12_CreateFcn(hObject, eventdata, handles)
% hObject    handle to desity12 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function desity12_Callback(hObject, eventdata, handles)
% hObject    handle to desity12 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of desity12 as text
%        str2double(get(hObject,'String')) returns contents of desity12 as a double
