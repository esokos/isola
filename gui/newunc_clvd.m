...
% Last Modified by GUIDE v2.5 02-Mar-2017 22:59:56
...
% code with  signed CLVD
            for ii=1:m
                [str1(ii),dp1(ii),rk1(ii),str2(ii),dp2(ii),rk2(ii),adc_1(ii),adc_2(ii),avol_1(ii),avol_2(ii),aclvd_1(ii),aclvd_2(ii)] = silsubnew2(r(ii,:));
            end
...
%             end  
             ...
             for ii=1:m
                 [str1(ii),dp1(ii),rk1(ii),str2(ii),dp2(ii),rk2(ii),adc_1(ii),adc_2(ii),avol_1(ii),avol_2(ii),aclvd_1(ii),aclvd_2(ii)] = silsubnew2(total_r(ii,:));
             end  
...
%             end              
             ...
             for ii=1:meq6
                 [str1(ii),dp1(ii),rk1(ii),str2(ii),dp2(ii),rk2(ii),adc_1(ii),adc_2(ii),avol_1(ii),avol_2(ii),aclvd_1(ii),aclvd_2(ii)] = silsubnew2(total_req6(ii,:));
             end
             ...
             if stype==1 % full MT
                ...
                figure
                hist(aclvd_2,xbins);title('CLVD% all sources eq6','FontSize',14);
                ax=gca;set(ax,'Linewidth',2,'FontSize',12);xlim([-100,100]);
...
%legend('Ni','Constant Ni','Location','northwest')
