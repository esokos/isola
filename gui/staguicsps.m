...
% 29/08/15 Update to use only two frequencies



disp('This is stagui.m  29/08/2015.')
  
if ispc   
   h=dir('.\csps\allstat.dat');
else
   h=dir('./csps/allstat.dat');
end
     ...
     return
      ...
      switch cnt
            case 9
                 ...
                 if ispc
                   [stanames,od1,od2,od3,od4,of1,of2,of3,of4] = textread('.\csps\allstat.dat','%s %f %f %f %f %f %f %f %f',-1);
                 else
                   [stanames,od1,od2,od3,od4,of1,of2,of3,of4] = textread('./csps/allstat.dat','%s %f %f %f %f %f %f %f %f',-1);
                 end
            case 6
                 ...
                 if ispc
                   [~,od1,od2,od3,od4,stanames] = textread('.\csps\allstat.dat','%s %f %f %f %f %s',-1);
                 else
                   [~,od1,od2,od3,od4,stanames] = textread('./csps/allstat.dat','%s %f %f %f %f %s',-1);
                 end
            ...
            case 5
                 ...
                 if ispc
                    [stanames,od1,od2,od3,od4] = textread('.\csps\allstat.dat','%s %f %f %f %f',-1);
                 else
                    [stanames,od1,od2,od3,od4] = textread('./csps/allstat.dat','%s %f %f %f %f',-1);
                 end
                 % assign default to f1 f2 f3 f4
...
freq22=freq11;freq33=freq44;

% uodate allstat
if ispc
  fid = fopen('.\csps\allstat.dat','w');
     for p=1:nsta
