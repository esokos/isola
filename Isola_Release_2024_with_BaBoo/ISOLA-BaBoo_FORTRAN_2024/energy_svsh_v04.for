...
c      character *17 statfil1, statfil2,statfil3
      ...
      open(105,file='eneinp0.dat')  
      open(110,file='eneinp1.dat')  
      open(200,file='eneout0.dat')
      open(201,file='eneout1.dat')
      open(210,file='eneout2.dat')
c      open(220,file='eneout3.dat')
c      open(230,file='integrand.dat')


c********************************************************** 
c    Reading eneinp0_v02.dat 
c**********************************************************      
      read(105, *)
      read(105, *)
...
cc    Using asp2 and visualizing integrand   
         ...
         spint=spint + contrib 
c        write(230,'(2(1x,e13.6))') freq, contrib
        enddo
c        write (230,*) '*'		
...
c********************************************************** 
c    Radiation patterns and their squares in future IT SHOULD BE A FUll-MT (non-DC) rad pat
c**********************************************************      
...
c	   pattp2=pattp**2.  !   
     ...
     *     0.5*sin(rak)*sin(2.*dip)*sin(2.*ang)*(sin(azi-str))**2.
	  pattsv2=pattsv**2.    ! Free surface factor 1.7 because of dominant incid angles 30 deg
