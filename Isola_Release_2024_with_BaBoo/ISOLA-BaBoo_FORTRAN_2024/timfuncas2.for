...
c
c     Processing the SECOND NTR triangles ONLY (source 1) 
...
c     write(*,*)          	dt,nsour,t0
	...
	do is=1,NTR		 ! skipping the first source 
	read(666,*) dummy,dummy,dummy
      enddo
c                      ! using the SECOND source 
	do 10 is=1,NTR  
...
c     XCOR=freq
c     YCOR=CABS(U(I))
c     WRITE(20,'(1X,E12.5,1X,E12.5)') XCOR,YCOR
...
c      do i=1,np
c      time=FLOAT(I-1)*DT
c      write(777,'(21(1x,e12.5))') time,(a(i,is),is=1,nsour)
c      enddo

      do i=1,np
      time=FLOAT(I-1)*DT
c      write(888, '(2(1x,e12.5))') time,b(i)
      write(888, '(2(1x,e12.5))') time-auxshift,b(i) ! NEW Aug 2, 2015
...
c      WRITE(999,'(2(1X,E12.5))') real(s(i)),aimag(s(i))
      ENDDO
