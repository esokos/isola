...
c 2022:
c ntim=1024
c open unformated files for Ifort
...
C     J. Zahradnik; June 2009
      ...
      CHARACTER *3 statname(31)

c     dimension  w(-1250:9442,31,3,6)
c     dimension w2(-1250:9442,31,3,6)
      dimension  w(8192,31,3,6)
      dimension w2(8192,31,3,6)
...
c      open(100,form='unformatted',file=filename)     ! Powerstation
      open(100,form='unformatted',file=filename,access='stream') ! Ifort, Gfort (input)
...
c      open(200,form='unformatted',file='elemsenew.dat')     ! Powerstation 
      open(200,form='unformatted',file='elemsenew.dat',
     *     access='stream',status='replace')                 ! Ifort 
