...
c      Depths (needed for inv1.dat plot) are taken from the GUI!
     ...
     *                 ff1(21),ff2(21),ff3(21),ff4(21),dt
      ...
      write(*,*)
	  write(*,*) 'This is NEWaspo9_1024Intel'
	  write(*,*)
...
c In standard Isola not needed; here yes due to prepsyn and filtmore
c where there is squaring of synthtics (e20)**2 for Hilbert transform 	  
C---------------------------------------------------------------------      
...
c      sx is  synth  filtered displacement(incl. focmech)
      ...
      call prepsyn_1024(sx,y1,y2) ! envelope and ampl.sp. of the synth displacement filtered	
c 	  write(*,*) 'prvni '
