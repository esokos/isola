...
c ntim=1024
      ...
      open(102,file='inv5.dat')    ! inv5.dat=input (it is output of isola) 

	  write(*,*) 'This is NORM_2024'
	  
      read(102,*) error3 ! misfit with Cdinv	  
      write(*,*) 'e3= ', error3	  
...
c       write(*,*) postvar !  last station of non-zero weights: peak ampl. squared 
     ...
     *      x3(itim,ir,1),x3(itim,ir,2),x3(itim,ir,3)
      ...
      write(101,*) anorm2,anorm1,varred,postvar,
     *          	  numbd,numbp,numbdf,error3
