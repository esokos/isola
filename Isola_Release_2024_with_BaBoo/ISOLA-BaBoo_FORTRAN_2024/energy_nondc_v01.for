...
c I tested that for purely DC source it gives exactly the same as the above DC radiation pattern       
     ...
     &- 2.*sin(dip)**2*sin(strike)**2)))
      ...
      pattp=Gp; pattp2=pattp**2
      pattsnew=Gs; pattsnew2=pattsnew**2 ! pattsnew2 = pattsv2 + pattsh2 = that is the same as patts2 below 
	  pattsv=Gsv; pattsv2=pattsv**2
      pattsh=Gsh; pattsh2=pattsh**2
