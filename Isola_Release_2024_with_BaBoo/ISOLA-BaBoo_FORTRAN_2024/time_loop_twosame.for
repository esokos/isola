...
c This is needed if two subevents have EQUAL focal mechanism
...
c      dimension bve2(nhdat)
     ...
     *                 ff1(21),ff2(21),ff3(21),ff4(21),dt
      ...
      write(*,*) 'This is time_loop_two_same'
      write(*,*)	  
...
c      goto 666 ! this allows for all pairs (e.g. pair [3,15] is NOT same as [15,3])
...
c  Printing matrix    
c	do j=1,numdat
c	write(555,'(12(1x,e12.5))') (ama(j,n),n=1,NTR2)
c	enddo
...
c      write(111,'(6(1x,e12.5))') (ampl(n),n=1,NTR)

	if(nonetwo.eq.2) then
c	WRITE(111,*)
c      write(111,'(6(1x,e12.5))') (ampl(n),n=NTR+1,NTR2)
	endif
...
!c     output: seimogram sx 
	...
	write(222,*) isour1,isour2
 	write(222,'(1x,e12.5,5x,i5)') dur, NTR 
	...
	write(222,'(i5,2(1x,e12.5))') i,shf,xmom
	enddo
