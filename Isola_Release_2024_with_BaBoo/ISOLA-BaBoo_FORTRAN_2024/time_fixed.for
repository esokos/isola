...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     *                 ff1(21),ff2(21),ff3(21),ff4(21),dt
      ...
      write(*,*) 'This is time_fixed_non-smooth, version 1024'	
...
c	  write(*,*) 'Weight should be ~ 4 orders higher than max of data' ! 2 to 5 orders higher
c      write(*,*) 'Users weight: default multiplied by ? (e.g. 1.) = '
c	  read (*,*) usermult  
c	  bvecnst = bvecnst * usermult  
c      write(*,*) 'Final choice of the moment weight = ', bvecnst
...
c caution: vector bve will be RE-WRITTEN (cannot be used second time)
	...
	write(111,*)
      ...
      write(111,'(6(1x,e12.5))') (ampl(n),n=1,NTR)

	if(nonetwo.eq.2) then
	WRITE(111,*)
      write(111,'(6(1x,e12.5))') (ampl(n),n=NTR+1,NTR2)
	endif
