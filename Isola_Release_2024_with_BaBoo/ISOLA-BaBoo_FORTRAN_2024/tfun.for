...
c     write(*,*) 'duration of elem. triangle: currently= ',t0
c     write(*,*) 'duration of elem. triangle: your preferred= ?'
c	  read(*,*) t0
c	  write(*,*) 'duration = ',t0
c	  write(*,*) 'duration of elem. triangle: currently= ',t0
...
c	  nsel1=num1
c	  nsel2=num2
c     write(*,*) 'selected pair from sel_pairs.dat, e.g.:', nsel1,nsel2
c	  read(*,*) nsel1,nsel2
c	  write(*,*) 'Wait, code is running ....'

       read(99,*) t0, nsel1,nsel2
...
c     U(I)=U(I)*cexp(-2*pi*ai*freq*(shift    ))   ! no time shift 
  ...
  25  continue
      ...
      CALL FCOOLR(NI,U,+1.) 
c	  !(zadna konst, protoze je to analyt predpis sp.)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       time=float(i-1)*dt	
	   write(999,'(4(1x,e12.5))') time-auxshift,sb(i),sc(i),sd(i) ! average time functions 
