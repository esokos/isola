...
on =[handles.lcut2,handles.hcut1, handles.text18,handles.text16];
enableon(on)

else
    
off =[handles.lcut2,handles.hcut1 ,handles.text18,handles.text16];
enableoff(off)
   ...
   if (get(handles.skipinst,'Value') == get(handles.skipinst,'Max'))
      ...
      %enable allign
       ...
       %  filtering AFTER instrumental correction 
          lcut2 = str2double(get(handles.lcut2,'String')); hcut1 = str2double(get(handles.hcut1,'String'));
