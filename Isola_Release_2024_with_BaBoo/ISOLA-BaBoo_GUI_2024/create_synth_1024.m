...
realdataall=zeros(1024,4,nostations);    %%%% 1024 points  fixed....
syntdataall=zeros(1024,4,nostations); 
...
% %%%%%%%%%%initialize data matrices
realdata=zeros(1024,4);   
syntdata=zeros(1024,4); 
