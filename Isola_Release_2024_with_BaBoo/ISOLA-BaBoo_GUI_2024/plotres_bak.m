...
% Last Modified by GUIDE v2.5 08-Oct-2019 09:25:35
...
if stypeorig==1 % delta 
  disp(['Centroid Time             '  num2str(srctime2(psrcpos)) '  (sec)' ])
elseif stypeorig==2 %triangle
  disp(['Centroid Time             '  num2str(srctime2(psrcpos)) '  (sec). Subtract triangle half-duration' ])   
end
                 ...
                 fprintf(fid,'%s\r\n',['Centroid Depth  (km)      : ' num2str(depth(srcpos(psrcpos)))]);
                     ...
                     if stypeorig==1 % delta 
                        if srctime2(psrcpos) < 0    
                            ...
                            fprintf(fid,'%s\r\n',['Centroid time        : ' num2str(srctime2(psrcpos)) ' (sec)' ]);
                        else
                            fprintf(fid,'%s\r\n','> 1 28 12 0 9 LM 10p 20c j');
                            fprintf(fid,'%s\r\n',['Centroid time        :  +' num2str(srctime2(psrcpos)) ' (sec)' ]);
                        end   
                     ...
                     elseif stypeorig==2 %triangle
                        if srctime2(psrcpos) < 0    
                            fprintf(fid,'%s\r\n','> 1 28 12 0 9 LM 10p 20c j');
                            fprintf(fid,'%s\r\n',['Centroid time        : ' num2str(srctime2(psrcpos)) ' (sec). Subtract triangle half-duration' ]);
                        else
                            fprintf(fid,'%s\r\n','> 1 28 12 0 9 LM 10p 20c j');
                            fprintf(fid,'%s\r\n',['Centroid time        :  +' num2str(srctime2(psrcpos)) ' (sec). Subtract triangle half-duration' ]);
                        end
