...
% Last Modified by GUIDE v2.5 27-Mar-2024 20:54:57
...
% --- Executes on button press in selsingle.
function selsingle_Callback(hObject, eventdata, handles)
% hObject    handle to selsingle (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

disp('Running uncertainty tool for DC, ISO and nodal lines for Selected subevent (fixed position).')
