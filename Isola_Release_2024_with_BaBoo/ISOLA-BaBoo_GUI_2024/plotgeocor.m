...
%           nsources=noSourcesstrike*noSourcesdip;
     ...
     elseif  strcmp(tsource,'3Dplane')
        ...
        noSourcesdip=fscanf(fid,'%i',1);
        dipstep=strikestep;
        depthstep=fscanf(fid,'%f %f %f',3); % fixed for 3 depths
...
%%    3D Planes
 disp('Plotting correlation for 3 horizontal planes of trial sources')


 cd invert

    % check if we have new format of correl file
    disp('New correlation file format only.')
               % read in new format
                 fid = fopen(cnm,'r');
                 [srcpos,srctime,variance,str1,dip1,rake1,str2,dip2,rake2,dc,volume,misfit,moment] = textread(cnm,'%f %f %f %f %f %f %f %f %f %f %f %f %f','headerlines',2);
                 fclose(fid);               
 ...
 disp(['At time shift   ' num2str(maxsrctime) '   and source   ' num2str(maxsource)])
 disp('          ')
...
%% find the 3 depths and the number of points in grid 
%depths

noSourcesstrike=handles.noSourcesstrike; noSourcesdip=handles.noSourcesdip;
singleplanegridpoints=noSourcesstrike*noSourcesdip;

% Prepare 3 files for the 3 depths from planecorrgeo* 
cname_noext=cname(1:strfind(cname,'.')-1);
depth1file=[cname_noext '_Depth1.dat']; depth2file=[cname_noext '_Depth2.dat']; depth3file=[cname_noext '_Depth3.dat'];

T = readtable(['.\gmtfiles\' cname]);

T1=T(1:singleplanegridpoints,:);  T2=T(singleplanegridpoints+1:2*singleplanegridpoints,:);T3=T(2*singleplanegridpoints+1:end,:);

% write in 3 files
writetable(T1,['.\gmtfiles\' depth1file],'Delimiter',' ','WriteVariableNames', 0); writetable(T2,['.\gmtfiles\' depth2file],'Delimiter',' ','WriteVariableNames', 0); writetable(T3,['.\gmtfiles\' depth3file],'Delimiter',' ','WriteVariableNames', 0)  
...
fid = fopen('.\gmtfiles\plcorgeo.bat','w');
          ...
          fprintf(fid,'%s\r\n',['gawk "{print $1,$2,$5}" ' depth1file ' >  corcongeo1.dat']);
          fprintf(fid,'%s\r\n',['gawk "{print $1,$2,$5}" ' depth2file ' >  corcongeo2.dat']);
          fprintf(fid,'%s\r\n',['gawk "{print $1,$2,$5}" ' depth3file ' >  corcongeo3.dat']);
          ...
          if anotornot == 1
             disp(' no annotation')
                 if gmt_ver==4
                    fprintf(fid,'%s\r\n',['pscontour corcongeo1.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -Ccr.cpt -K -A- -I  -B' num2str(anot) ' > ' psname ]);
                    fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                 else
                    fprintf(fid,'%s\r\n',['pscontour corcongeo1.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -BeWnS+t' ['"Depth ' num2str(depths(1)) '"'] ' -Ccr.cpt -K -A- -I  -B' num2str(anot) ' > ' psname ]);
                    fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                 end
         else
                if gmt_ver==4
                   fprintf(fid,'%s\r\n',['pscontour corcongeo1.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -Ccr.cpt -K -A+a0+s10+p+o+gwhite -I  -B' num2str(anot) ' > ' psname ]);
                   fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                else
                   fprintf(fid,'%s\r\n',['pscontour corcongeo1.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -BeWnS+t' ['"Depth ' num2str(depths(1)) '"']  '  -Ccr.cpt -K -A+a0+f10+p+o+gwhite -I  -B' num2str(anot) ' > ' psname ]);
                   fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                end
         end
         ...
         if plsym == 1
             ...
             if paddsnum == 1
                 fprintf(fid,'%s\r\n',['gawk "{ print $1,$2,' num2str(bballtsize) ', 0 , 1 ,\"CT\",$3}"  corcongeo1.dat ' ' > stext.dat ']);
                 fprintf(fid,'%s\r\n',['pstext -R  -J  stext.dat -K -O -D0c/' num2str(ssize+0.2)        'c >> ' psname ]);
             else
             end
             if gmt_ver==4
                 fprintf(fid,'%s\r\n',['psxy -R  -J  corcongeo1.dat -S' ssymbol num2str(ssize) 'c   -W1p/0 -K -O -G' num2str(red) '/'  num2str(green) '/' num2str(blue)   ' >> ' psname ]);
             else
                 fprintf(fid,'%s\r\n',['psxy -R  -J  corcongeo1.dat -S' ssymbol num2str(ssize) 'c   -W1p -K -O -G' num2str(red) '/'  num2str(green) '/' num2str(blue)   ' >> ' psname ]);
             end
          end
         ...
         if pbeachtext==1
             fprintf(fid,'%s\r\n',['gawk "{ if ($5>' num2str(bballcut) ') print $1,$2,$12,$6,$7,$8,"5"           }"  planecorrgeo01_Depth1.dat '  ' > testfoc.dat ']);
         else
             fprintf(fid,'%s\r\n',['gawk "{ if ($5>' num2str(bballcut) ') print $1,$2,$12,$6,$7,$8,"5","0","0",$3}"  planecorrgeo01_Depth1.dat '  ' > testfoc.dat ']);
         end
        ...
        % fprintf(fid,'%s\r\n',['psscale -D'  num2str(mapscale+4)  'c/4c/7c/0.3c -O -Ccr.cpt -K   -B0.1:Correlation: >> ' psname ]);
        % fprintf(fid,'%s\r\n',['psscale -D'  num2str(mapscale+4)  'c/13c/7c/0.3c -O -Cdc.cpt -K -L  -B::/:DC\045: >> ' psname ]);
         fprintf(fid,'%s\r\n',['psxy -R -J -Sa0.8c origins.dat -Wthick  -O -K  >> ' psname ]);
         ...
         %% Next depth  
          ...
          if anotornot == 1
             disp(' no annotation')
                 if gmt_ver==4
                    fprintf(fid,'%s\r\n',['pscontour corcongeo2.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -Ccr.cpt -A- -I  -K -O  -X' num2str(mapscale+1) 'c -B' num2str(anot) ' >> ' psname ]);
                    fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                 else
                    fprintf(fid,'%s\r\n',['pscontour corcongeo2.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -BewnS+t' ['"Depth ' num2str(depths(2)) '"']  '  -Ccr.cpt -A- -I  -K -O  -X' num2str(mapscale+1) 'c  >> ' psname ]);
                    fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                 end
         else
                if gmt_ver==4
                   fprintf(fid,'%s\r\n',['pscontour corcongeo2.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -Ccr.cpt -A+a0+s10+p+o+gwhite -I -K -O  -X' num2str(mapscale+1) 'c -B' num2str(anot) ' >> ' psname ]);
                   fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                else
                   fprintf(fid,'%s\r\n',['pscontour corcongeo2.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -BewnS+t' ['"Depth ' num2str(depths(2)) '"']   ' -Ccr.cpt -A+a0+f10+p+o+gwhite -I -K -O -X' num2str(mapscale+1) 'c -B' num2str(anot) ' >> ' psname ]);
                   fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                end
         end
         ...
         if plsym == 1
             ...
             if paddsnum == 1
                 fprintf(fid,'%s\r\n',['gawk "{ print $1,$2,' num2str(bballtsize) ', 0 , 1 ,\"CT\",$3}"  corcongeo2.dat ' ' > stext.dat ']);
                 fprintf(fid,'%s\r\n',['pstext -R  -J  stext.dat -K -O -D0c/' num2str(ssize+0.2)        'c >> ' psname ]);
             else
             end
             if gmt_ver==4
                 fprintf(fid,'%s\r\n',['psxy -R  -J  corcongeo2.dat -S' ssymbol num2str(ssize) 'c   -W1p/0 -K -O -G' num2str(red) '/'  num2str(green) '/' num2str(blue)   ' >> ' psname ]);
             else
                 fprintf(fid,'%s\r\n',['psxy -R  -J  corcongeo2.dat -S' ssymbol num2str(ssize) 'c   -W1p -K -O -G' num2str(red) '/'  num2str(green) '/' num2str(blue)   ' >> ' psname ]);
             end
          end
         ...
         if pbeachtext==1
             fprintf(fid,'%s\r\n',['gawk "{ if ($5>' num2str(bballcut) ') print $1,$2,$12,$6,$7,$8,"5"           }"  planecorrgeo01_Depth2.dat '  ' > testfoc.dat ']);
         else
             fprintf(fid,'%s\r\n',['gawk "{ if ($5>' num2str(bballcut) ') print $1,$2,$12,$6,$7,$8,"5","0","0",$3}"  planecorrgeo01_Depth2.dat '  ' > testfoc.dat ']);
         end
         ...
         %% Last depth  
          ...
          if anotornot == 1
             disp(' no annotation')
                 if gmt_ver==4
                    fprintf(fid,'%s\r\n',['pscontour corcongeo3.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -Ccr.cpt -A- -I  -K -O  -X' num2str(mapscale+1) 'c -B' num2str(anot) ' >> ' psname ]);
                    fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                 else
                    fprintf(fid,'%s\r\n',['pscontour corcongeo3.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -BewnS+t' ['"Depth ' num2str(depths(3)) '"']  '  -Ccr.cpt -A- -I  -K -O  -X' num2str(mapscale+1) 'c  >> ' psname ]);
                    fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                 end
         else
                if gmt_ver==4
                   fprintf(fid,'%s\r\n',['pscontour corcongeo3.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -Ccr.cpt -A+a0+s10+p+o+gwhite -I -K -O  -X' num2str(mapscale+1) 'c -B' num2str(anot) ' >> ' psname ]);
                   fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                else
                   fprintf(fid,'%s\r\n',['pscontour corcongeo3.dat -R' num2str(min(xposgeo)-mapborder) '/' num2str(max(xposgeo)+mapborder)  '/' num2str(min(yposgeo)-mapborder) '/' num2str(max(yposgeo)+mapborder) ' -JM' num2str(mapscale) 'c -W' num2str(cpen) 'p -BewnS+t' ['"Depth ' num2str(depths(3)) '"']   ' -Ccr.cpt -A+a0+f10+p+o+gwhite -I -K -O -X' num2str(mapscale+1) 'c -B' num2str(anot) ' >> ' psname ]);
                   fprintf(fid,'%s\r\n',['pscoast -R -J -Wthin -K -O -Df -Lfx' num2str(legendX) '/' num2str(legendY) '/' num2str(  min(yposgeo)+(max(yposgeo)-min(yposgeo))/2 ) '/' num2str(legendL) 'k+l' ' >> ' psname ]);
                end
         end
         ...
         if plsym == 1
             ...
             if paddsnum == 1
                 fprintf(fid,'%s\r\n',['gawk "{ print $1,$2,' num2str(bballtsize) ', 0 , 1 ,\"CT\",$3}"  corcongeo3.dat ' ' > stext.dat ']);
                 fprintf(fid,'%s\r\n',['pstext -R  -J  stext.dat -K -O -D0c/' num2str(ssize+0.2)        'c >> ' psname ]);
             else
             end
             if gmt_ver==4
                 fprintf(fid,'%s\r\n',['psxy -R  -J  corcongeo3.dat -S' ssymbol num2str(ssize) 'c   -W1p/0 -K -O -G' num2str(red) '/'  num2str(green) '/' num2str(blue)   ' >> ' psname ]);
             else
                 fprintf(fid,'%s\r\n',['psxy -R  -J  corcongeo3.dat -S' ssymbol num2str(ssize) 'c   -W1p -K -O -G' num2str(red) '/'  num2str(green) '/' num2str(blue)   ' >> ' psname ]);
             end
          end
         ...
         if pbeachtext==1
             fprintf(fid,'%s\r\n',['gawk "{ if ($5>' num2str(bballcut) ') print $1,$2,$12,$6,$7,$8,"5"           }"  planecorrgeo01_Depth3.dat '  ' > testfoc.dat ']);
         else
             fprintf(fid,'%s\r\n',['gawk "{ if ($5>' num2str(bballcut) ') print $1,$2,$12,$6,$7,$8,"5","0","0",$3}"  planecorrgeo01_Depth3.dat '  ' > testfoc.dat ']);
         end
         ...
         fprintf(fid,'%s\r\n',['psscale -Dn1.1/0.0+w7c/0.3c -R -J -O -K -Ccr.cpt    -B0.1:Correlation: >> ' psname ]);
         fprintf(fid,'%s\r\n',['psscale -Dn1.1/1.1+w7c/0.3c -R -J -O    -Cdc.cpt -L -B::/:DC\045: >> ' psname ]);
