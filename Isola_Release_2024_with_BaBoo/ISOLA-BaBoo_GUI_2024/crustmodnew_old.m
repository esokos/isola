function varargout = crustmodnew(varargin)
% CRUSTMODNEW M-file for crustmodnew.fig
%      CRUSTMODNEW, by itself, creates a new CRUSTMODNEW or raises the existing
%      singleton*.
%
%      H = CRUSTMODNEW returns the handle to a new CRUSTMODNEW or the handle to
%      the existing singleton*.
%
%      CRUSTMODNEW('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CRUSTMODNEW.M with the given input arguments.
%
%      CRUSTMODNEW('Property','Value',...) creates a new CRUSTMODNEW or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before crustmodnew_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to crustmodnew_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help crustmodnew

% Last Modified by GUIDE v2.5 27-Nov-2013 21:50:55

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @crustmodnew_OpeningFcn, ...
                   'gui_OutputFcn',  @crustmodnew_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before crustmodnew is made visible.
function crustmodnew_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to crustmodnew (see VARARGIN)
...
% UIWAIT makes crustmodnew wait for user response (see UIRESUME)
% uiwait(handles.crustmodnew);


% --- Outputs from this function are returned to the command line.
function varargout = crustmodnew_OutputFcn(hObject, eventdata, handles) 
