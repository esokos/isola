...
% Last Modified by GUIDE v2.5 10-Apr-2024 20:49:52
...
set(handles.nocova,'Value',1)
set(handles.cova,'Value',0)
...
%check what type we need COVA or NO COVA
cova=get(handles.cova,'Value');
nocova=get(handles.nocova,'Value');
...
% --- Executes on button press in cova.
function cova_Callback(hObject, eventdata, handles)
% hObject    handle to cova (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of cova
%get(handles.nocova,'Value')
set(handles.nocova,'Value',0)

set(handles.jackcomp,'Enable','off')
set(handles.plcompres,'Enable','off')


% --- Executes on button press in nocova.
function nocova_Callback(hObject, eventdata, handles)
% hObject    handle to nocova (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of nocova
set(handles.cova,'Value',0)

set(handles.jackcomp,'Enable','on')
set(handles.plcompres,'Enable','on')
