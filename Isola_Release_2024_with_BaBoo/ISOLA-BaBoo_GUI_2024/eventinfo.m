...
if exist('duration.isl', 'file') == 2
   ...
   fclose(fid);
     ...
     tl=307.2;         % default TWL

end

% Populate the list select the default value based on duration.isl

     TLs = [cellstr(num2str(102.4)) ; cellstr(num2str(204.8))  ; cellstr(num2str(307.2))  ; ...
            cellstr(num2str(409.6)) ; cellstr(num2str(1024)) ; cellstr(num2str(2048)) ];
...
%% ********************* OLD CODE ********* npts is fixed at 1024 now 
% populate listbox
% if npts == 8192
% 
...
disp('This is Eventinfo 29/04/2024');
disp('1024 point version');
% Layout Change 28/08/2013
% change TWL based on fixed 1024 points
