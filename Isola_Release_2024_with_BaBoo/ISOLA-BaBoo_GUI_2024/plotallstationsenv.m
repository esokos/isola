...
realdataall=zeros(npts,4,nostations);    %%%% npts points based on isolacfg.isl 02/12/2022
...
%we expect data in form nptsx4 1st column time 2nd NS etc...
