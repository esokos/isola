...
% set Pre filter option to 0
set(handles.selfilter,'Value',0)
...
%% we should not use text from GUI as resampling freq it is rounded !!
...
%dt=1/newfreq 
% changed to solve a small bug 02/12/2022
dt=tl/npts
...
try
  t=handles.t;
   ...
   disp('Problem finding default taper. Assigning a value of 2.');
   t=2;
end
           disp(['applying taper of '  num2str(t) ' s' ])
           % taper data
