function [str1,dip1,rake1,str2,dip2,rake2,adc_1,adc_2,avol_1,avol_2,aclvd_1,aclvd_2,amt] = silsubnew2(a)
...
%             %c     write(2,'('' V(implosive):'',t16,f5.1,''%'')')amv1
      ...
      if  (angll1 < angll2) 
        ...
        aclvd_1=(-1.)*aclvd;   % ! this is signed CLVD, new sept2017
      end
...
%             %c     write(2,'('' V(implosive):'',t16,f5.1,''%'')')amv1
      ...
      adc=100.-abs(amv1)-aclvd;

      if (angll1 < angll2)
         aclvd_2=aclvd;  
      else
         aclvd_2=(-1.)*aclvd; %! this is signed CLVD, new sept2017
      end
      
 	  %avol_2=sign2(amv1,amv);
      
      avol_2=amv1;   % following Jiri's email
