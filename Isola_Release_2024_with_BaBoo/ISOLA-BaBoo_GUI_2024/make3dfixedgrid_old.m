...
disp('Calculating coordinates of 25 sources ')  
...
for d=1:3
 for j=1:noSourcesdip 
    ...
    TextXY=[TextXY;reshape(str',[25,1])];
end
% add text 
...
ntsources=noSourcesdip*noSourcesstrike*3; 
 ...
 fid2 = fopen('tsources.isl','w');
    ...
    fprintf(fid2,'%i\r\n',noSourcesdip);
    fprintf(fid2,'%i\r\n',depthgridstep);
    fprintf(fid2,'%s\r\n','Sources (5x5) on 3 horizontal planes');
  fclose(fid2);            
