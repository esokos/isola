      program conshift
c
ccc       fixed  N=8192 (mm=13) and dt=TL/8192 now 163.84/8192=0.02
...
c    xxxxxxxxxxxxxxxxx
      ...
      do ir=1,nr
      numf1=2000+(ir*1)
      statfil1='s'//statname(ir)//'row.dat'
...
c      call cmoment (mu(is),strike(is),dip(is),
c     &             rake(is),disp(is),width(is)*length(is),a(1,is))

c      a(1,is)=0 ! 1*disp(is)
c      a(2,is)=0 ! 1*disp(is)
c      a(3,is)=0 ! 1*disp(is)
c      a(4,is)=-0.667*2.97586e+009
c      a(5,is)=-0.667*2.97586e+009
c      a(6,is)=-1.667*2.97586e+009
       ...
       read(16,*) a(5,is)
       read(16,*) a(6,is)
       write(*,*) a(1,is),a(2,is),a(3,is),a(4,is),a(5,is),a(6,is)     
       close(16)
...
c       et une source isotrope)
 	...
 	a(5) = (x1 -2*x4 + x6)/3.
        a(6) =  0.
c	a(6) = (x1+x4+x6)/3. ! obecne; pro vyse predepsane x' to da cistou nulu
                    ! pokud zadam x1...x6 jako nonDC, bude to take pocitat dobre

        write(*,*) 'comom'
        write(*,*) 'a4,5,6',a(4),a(5),a(6)
