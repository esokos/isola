...
c     Processing the SECOND 12 triangles ONLY (source 2) 
...
c      U(I)=U(I)*cexp(-2*pi*ai*freq*(shift    ))   ! no time shift 
      U(I)=U(I)*cexp(-2*pi*ai*freq*(shift+50.))   ! no time shift 
...
c      write(888, '(2(1x,e12.6))') time,b(i)
      write(888, '(2(1x,e12.6))') time-50.,b(i)
      enddo
